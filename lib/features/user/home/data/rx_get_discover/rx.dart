...
import 'package:oscaru95/features/user/home/data/rx_get_discover/api.dart';
...
final class GetDiscoverRx extends RxResponseInt<DiscoverResponse> {
  GetDiscoverRx({required super.empty, required super.dataFetcher});

  ValueStream get getDiscoverStream => dataFetcher.stream;
  final api = GetDiscoverApi.instance;

  Future<bool> getDiscover() async {
    try {
      final data = await api.getDiscover();
