...
final class GetFavouriteRx extends RxResponseInt<FavouriteResponse> {
  GetFavouriteRx({required super.empty, required super.dataFetcher});

  ValueStream get favouriteStream => dataFetcher.stream;
  final api = GetFavouriteApi.instance;

  Future<bool> getFavourite() async {
    try {
      final data = await api.getFavourite();
