...
import 'package:oscaru95/features/user/profile/data/rx_logout_user/api.dart';
...
final class UserLogoutRx extends RxResponseInt<Map> {
  UserLogoutRx({required super.empty, required super.dataFetcher});

  ValueStream get userLogoutStream => dataFetcher.stream;
  final api = UserLogoutApi.instance;
