...
import 'package:oscaru95/features/merchant/merchant_profile/data/rx_business_profile/api.dart';
...
final class BusniessProfileRx extends RxResponseInt<BusinessProfileResponse> {
  BusniessProfileRx({required super.empty, required super.dataFetcher});

  ValueStream get getBusniessProfileStream => dataFetcher.stream;
  final api = BusniessProfileApi.instance;

  Future<bool> getBusinessProfile() async {
    try {
      final data = await api.getBusinessProfile();
