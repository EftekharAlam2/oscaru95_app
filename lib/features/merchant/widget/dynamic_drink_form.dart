...
class DynamicDrinkForm extends StatefulWidget {
  ...
  @override
  State<DynamicDrinkForm> createState() => _DynamicDrinkFormState();
}

class _DynamicDrinkFormState extends State<DynamicDrinkForm> {
    ...
    return Column(
      children: [
        ...
        ...List.generate(drinkItems.length, (index) {
          return _buildDrinkContainer(index);
        }),
  ...
  Widget _buildDrinkContainer(int index) {
