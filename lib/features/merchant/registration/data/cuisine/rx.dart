...
import 'package:oscaru95/features/merchant/registration/data/cuisine/api.dart';
...
final class GetCusinRx extends RxResponseInt<CategoriesModel> {
  GetCusinRx({required super.empty, required super.dataFetcher});

  ValueStream<CategoriesModel> get getCategory => dataFetcher.stream;
  final api = GetCusinApi.instance;
